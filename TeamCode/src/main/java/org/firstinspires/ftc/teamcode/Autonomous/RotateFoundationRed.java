...
@Autonomous(name = "Turn Foundation (Red, Pass through)", group = "Sensor")
public class RotateFoundationRed extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //Bring foundation back into building site and turn it
            strafeLeftWithEncoders(0.5,2700);
            turnRightWithEncoders(0.5,2100);
            FoundationServo1.setPosition(0.5);
            FoundationServo2.setPosition(0.5);
            delay(500);

            //Navigate under the skybridge
            strafeLeftWithEncoders(0.5,2100);
